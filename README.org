...
#+END_SRC
  ...
  Then its as simple as replacing my Stockholm symptoms rant with your
  own rant (advised but not required), and paste your own elisp init.el
  between the #+BEGIN & #+END SRC tags, then you're done. Re-factor into
  smaller source code blocks as appropriate to your [[http://en.wiktionary.org/wiki/yak_shaving][yak shaving]]
